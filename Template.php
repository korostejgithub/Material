...
$connect = new PDO("mysql:host=localhost; dbname=material", "_materialsvc@localhost", "KEline123%");
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr>
      ...
      <td><a href="NewDataTemplate.php?GetID= '.$row["ID"].'" >Use</a></td>
    </tr>
    '
    ;
  }
