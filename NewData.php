...
$query = " select ID from information ORDER BY ID DESC LIMIT 1";
...
<button id="myBtn" class="myButton" style="margin-left: 90%">Templates</button>
...
<form name = "form1" action="NewDataAdder.php" method = "POST" enctype = "multipart/form-data">
...
<div class="container" style="">
      <br />
      <div class="card" style="width:200px; height:40px; margin-top: 0px ; margin-left: 400px; margin-top: -10px; background-color: lightgrey" >
...
<td><textarea name="Termek_megnevezese_HU" style="background-color: #EAEAEA; width:30%" maxlength="40" ></textarea>
</tr>
<tr>
<td style=" font-weight: bold;" > Termek megnevezese (ENG) </td>
<td><textarea name="Termek_megnevezese_EN" style="background-color:#EAEAEA; width:30%" maxlength="40"  ></textarea>
</tr>


<tr>
<td style=" font-weight: bold;"> Region </td>
<td><select class="select-css" name="Region"  style="background-color:#EAEAEA;">
	<option value=""> Please Select </option>
<?php
...
<td>	<select class="select-css" name="Zsiros"  style="background-color:#EAEAEA;">
	<option value=""> Please Select </option>
<?php
...
<td>
	<select class="select-css" name="Egalizalt"  style="background-color:#EAEAEA;">
	<option value=""> Please Select </option>
<?php
...
<td><select class="select-css" name="Eloallito_gyar"  style="background-color:#EAEAEA;">
	<option  value=""> Please Select </option>
<?php
...
<td><select class="select-css" name="Termekcsoport_gyartovonal"  style="background-color:#EAEAEA;">
	<option value=""> Please Select </option>
<?php
...
<td><input type="text" name="Db_termek_karton" style="background-color:#EAEAEA; width:30%; border-color: #EAEAEA" autocomplete="off" ></td>
</tr>

<tr>
<td style=" font-weight: bold;"> Db termek/raklap </td>
<td><input type="text" name="Db_termek_raklap" style="background-color:#EAEAEA; width:30%; border-color: #EAEAEA" autocomplete="off" ></td>
</tr>
...
<option value="nem relevans"> Please Select </option>
<?php
